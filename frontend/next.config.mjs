        ...
        headers: [
          ...
          // All known external origins (AdSense, GTM, GA4, Google Fonts, profile images, R2) are explicitly allowlisted.
          {
            ...
            value: [
              ...
              "connect-src 'self' wss: ws: https: http://localhost:* ws://localhost:* http://127.0.0.1:* ws://127.0.0.1:* https://www.google-analytics.com https://analytics.google.com https://region1.analytics.google.com https://pagead2.googlesyndication.com https://api.razorpay.com https://lumberjack-cx.razorpay.com https://unpkg.com",
