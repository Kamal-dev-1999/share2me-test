...
export function SplashScreen() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex items-center justify-center bg-[#CDC3E4] transition-opacity duration-1000 ease-in-out overflow-hidden ${show ? "opacity-100" : "opacity-0 pointer-events-none"
        }`}
    >
