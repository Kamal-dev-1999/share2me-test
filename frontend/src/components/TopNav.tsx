    ...
    <nav className="h-[72px] bg-background/80 backdrop-blur-md border-b border-border flex items-center justify-center sticky top-0 z-50">
      <div className="w-full max-w-[1440px] px-6 lg:px-8 flex items-center justify-between relative" ref={menuRef}>
        ...
        <div className="hidden md:flex items-center gap-1.5 ml-12 lg:ml-16">
          ...
          <Link href="/pricing" className="px-4 py-2 rounded-lg text-[14px] font-medium text-primary hover:text-primary-hover hover:bg-border/50 transition-all font-bold">
            Pricing
          </Link>
        </div>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              <Link href="/pricing" onClick={() => setIsMenuOpen(false)} className="px-4 py-3 rounded-xl text-[15px] font-bold text-primary hover:text-primary-hover hover:bg-background-card transition-all flex items-center gap-3">
                Pricing
              </Link>
            </motion.div>
          )}
