...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "To keep your permanent inbox and custom Share Code active, you will need to upgrade to a Pro subscription (₹499/month). If you choose not to subscribe, your portal will be temporarily paused, but your account remains safe."
    },
    {
        ...
        <main className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-16">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
            ...
            <p className="text-text-secondary text-sm sm:text-base max-w-lg mx-auto font-body">
              Receive large files and clipboard text from anyone directly into your personal dashboard. Free for 1 month, then just ₹499/mo.
            </p>
          </div>
